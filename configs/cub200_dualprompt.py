...
def get_args_parser(subparsers):
	...
	# Optional switches for custom experiments
	subparsers.add_argument('--use_transform', action='store_true', help='Use SLCA transforms')
	subparsers.add_argument('--use_clip_grad', default=True, type=bool, help='Using gradient clipping')
	subparsers.add_argument('--SLCA', action='store_true', help='Perform training on top of SLCA')
	subparsers.add_argument('--logit_norm', default=0.1, type=float, help='Value of logit normalizer')
	...
	subparsers.add_argument('--sched', default='cosine', choices=['cosine', 'multistep', 'constant'], type=str, metavar='SCHEDULER', help='LR scheduler (default: "cosine"')
	subparsers.add_argument('--lr', type=float, default=0.001, metavar='LR', help='learning rate (default: 0.001)')
	subparsers.add_argument('--lr_orig', type=float, default=0.01, metavar='LR', help='original model learning rate')
	subparsers.add_argument('--lr_cls', type=float, default=0.01, metavar='LR', help='classifier learning rate')
	subparsers.add_argument('--lr_rps', type=float, default=0.0001, metavar='LR', help='prompt/rps learning rate')
